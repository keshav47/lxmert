...
class NLVR2Dataset:
    ...
    def __init__(self, splits: str):
        ...
        for split in self.splits:
            self.data.extend(json.load(open("/home/ubuntu/filestore/product_matching/data/lxmert/%s.json" % split)))
...
class NLVR2TorchDataset(Dataset):
    def __init__(self, dataset: NLVR2Dataset):
        ...
        if 'train' in dataset.splits:
            img_data.extend(load_obj_tsv('/home/ubuntu/filestore/keshav/lxmert/data/common_data/model/train_obj36.tsv', topk=topk))
